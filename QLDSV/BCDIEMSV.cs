...
namespace QLDSV {
    ...
    public class BCDIEMSV : ReportClass {
    ...
    public class CachedBCDIEMSV : Component, ICachedReport {
        
        public CachedBCDIEMSV() {
        }
