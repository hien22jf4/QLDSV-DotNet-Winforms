...
namespace QLDSV {
    ...
    public class DSSV_LOPHP : ReportClass {
    ...
    public class CachedDSSV_LOPHP : Component, ICachedReport {
        
        public CachedDSSV_LOPHP() {
        }
