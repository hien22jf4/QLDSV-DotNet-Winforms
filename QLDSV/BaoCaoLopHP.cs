...
namespace QLDSV {
    ...
    public class BaoCaoLopHP : ReportClass {
    ...
    public class CachedBaoCaoLopHP : Component, ICachedReport {
        
        public CachedBaoCaoLopHP() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            BaoCaoLopHP rpt = new BaoCaoLopHP();
            rpt.Site = this.Site;
            return rpt;
        }
